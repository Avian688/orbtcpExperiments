...
if __name__ == "__main__":
    ...
    for result in results:
        colorNum = 0
        queueName = "simplenetworkpathchange.constantRouter1.ppp["
        lastQueue = 0
        ...
        for mod in result.module.to_numpy():
            if(mod == "simplenetworkpathchange.constantRouter1.ppp[" + str(5) + "]"+".queue"):
                break
            numpyIndex = numpyIndex + 1
            
        yAxis = result.vecvalue.to_numpy()[numpyIndex]
        #print(results.vecvalue)
        plt.plot(result.vectime.to_numpy()[numpyIndex],yAxis*1000
