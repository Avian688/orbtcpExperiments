...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        for qs in queueSizes:
            ...
            fileName =  '../../paperExperiments/experiment6FrontTail/experiment6FrontTail_' + alg + '_' + queueIniTitle + '.ini'
            ...
            with open(fileName, 'w') as f:
                ...
                if(algFlavour == "TcpCubic"):
                    ...
                    f.write('\n' + '**.ppp[*].queue.typename = "BandwidthRecorderFrontTailQueue"\n')
                    ...
                    f.write('\n' + '**.router[0].ppp[2].queue.typename = "IntFrontTailQueue"\n')
                    for i in range(1, numOfRibClients):
                        f.write('\n' + '**.router[' + str(i) + '].ppp[3].queue.typename = "IntFrontTailQueue"\n')
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment6FrontTail/.')]
                ...
                for xmlFile in dir:
                    ...
                    for i in range(numOfRuns):
                        ...
                        configName = alg.title() + "_" + str(scenarioName) + "_" + queueIniTitle + "_" + "Run" + str(i+1)
                        print(configName)
                        f.write('\n' + '[Config ' + configName + ']')
                        f.write('\n' + 'extends = General \n')
                        ...
                        scenario_doc = 'xmldoc("../scenarios/experiment6FrontTail/'+ str(scenarioName) + '.xml")'
                        f.write('\n' + '*.scenarioManager.script = ' + scenario_doc + '\n')
                        if alg == "satcp":
                            f.write('\n' + '**.tcp.scenario = ' + scenario_doc + '\n')
                        f.write('\n' + 'sim-time-limit = ' + str(rtt * 2000) +'s \n')
    out_dir = Path('../../paperExperiments/experiment6FrontTail')
    for qs in queueSizes:
        if(qs == 0.2):
            queueIniTitle = "smallbuffer"
        elif(qs == 1):
        ...
        clone_raynet_ini_variants(out_dir / f"experiment6FrontTail_bbr_{queueIniTitle}.ini")
