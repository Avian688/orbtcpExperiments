...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        for qs in queueSizes:
            ...
            fileName =  '../../paperExperiments/experiment5FrontTail/experiment5FrontTail' + '_' + alg + '_' + queueIniTitle + '.ini'
            ...
            with open(fileName, 'w') as f:
                ...
                if(algFlavour == "TcpCubic"):
                    ...
                    f.write('\n' + '**.router1.ppp[2].queue.typename = "IntFrontTailQueue"\n')
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment5FrontTail/.')]
                ...
                for xmlFile in dir:
                    ...
                    for i in range(numOfRuns):
                        ...
                        scenario_doc = 'xmldoc("../scenarios/experiment5FrontTail/'+ str(scenarioName) + '.xml")'
                        f.write('\n' + '*.scenarioManager.script = ' + scenario_doc + '\n')
                        if alg == "satcp":
                            f.write('\n' + '**.tcp.scenario = ' + scenario_doc + '\n')
                        f.write('\n' + 'sim-time-limit = ' + str(rtt * 2000) +'s \n')
    out_dir = Path('../../paperExperiments/experiment5FrontTail')
    for qs in queueSizes:
        if(qs == 0.2):
            queueIniTitle = "smallbuffer"
        elif(qs == 1):
        ...
        clone_raynet_ini_variants(out_dir / f"experiment5FrontTail_bbr_{queueIniTitle}.ini")
