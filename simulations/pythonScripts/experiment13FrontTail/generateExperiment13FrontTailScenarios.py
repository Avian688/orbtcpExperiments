...
from experiment13FrontTailSupport import HANDOVER_INTERVAL_S, RUNS, SIMULATION_TIME_S, WORKLOADS, scenario_name
...
def main() -> None:
    out_dir = Path("../../paperExperiments/scenarios/experiment13FrontTail")
