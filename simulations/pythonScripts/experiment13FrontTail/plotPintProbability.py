...
from experiment13FrontTailSupport import MSS_BYTES, PINT_VARIANTS, RUNS, VARIANTS, WORKLOADS, workload_label
...
CSV_ROOT = SIMULATIONS_DIR / "paperExperiments" / "experiment13FrontTail" / "csvs"
SCENARIO_ROOT = SIMULATIONS_DIR / "paperExperiments" / "scenarios" / "experiment13FrontTail"
PLOT_ROOT = SIMULATIONS_DIR / "plots" / "experiment13FrontTail"
...
def plot_individual_response(workload: str, run: int) -> None:
    ...
    export_plot_dataframe(
        ...
        metadata={
            "experiment": "experiment13FrontTail",
            "workload": workload,
            "run": run,
