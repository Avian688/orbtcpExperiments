...
EXPERIMENT_DIR = (SCRIPT_DIR / "../../paperExperiments/experiment13FrontTail").resolve()
...
def generate_inputs() -> None:
    run_checked([sys.executable, "generateExperiment13FrontTailScenarios.py"], SCRIPT_DIR)
    run_checked([sys.executable, "generateExperiment13FrontTailIniFile.py"], SCRIPT_DIR)
...
def run_simulations(cores: int) -> None:
    ...
    runtime_file = SCRIPT_DIR / "experiment13FrontTailrunTimes.txt"
