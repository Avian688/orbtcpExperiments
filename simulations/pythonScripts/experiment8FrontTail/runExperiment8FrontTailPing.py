...
from raynetExperimentSupportFrontTail import build_opp_run_command

SCRIPT_DIR = Path(__file__).resolve().parent
SIMULATIONS_DIR = SCRIPT_DIR.parent.parent
PAPER_EXPERIMENT_DIR = SIMULATIONS_DIR / "paperExperiments" / "experiment8FrontTail"
RESULTS_DIR = PAPER_EXPERIMENT_DIR / "results"
PING_CSV_ROOT = PAPER_EXPERIMENT_DIR / "csvs" / "ping"
INI_FILE = PAPER_EXPERIMENT_DIR / "experiment8FrontTail_ping.ini"
...
def parse_args():
    ...
    parser.add_argument(
        "--generate-only",
        action="store_true",
        help="Only write experiment8FrontTail_ping.ini.",
    )
    parser.add_argument(
        "--skip-run",
        action="store_true",
