...
def plot_exp11_scatter_norm_util_vs_norm_delay(df):
    export_plot_dataframe(
        "norm_util_vs_norm_delay_experiment11FrontTail_points.csv",
        df.rename(columns={
        ...
        metadata={
            "experiment": "experiment11FrontTail",
            "plot": "norm_util_vs_norm_delay_experiment11FrontTail",
    ...
    plt.savefig("norm_util_vs_norm_delay_experiment11FrontTail.pdf", dpi=1080, bbox_inches="tight", pad_inches=0.02)
    plt.close(fig)
