...
def run_config_batch(configEntries, cores, paperExperimentDir):
    ...
    for cc, configName in configEntries:
        ...
        processList.append((subprocess.Popen(
            build_simulation_command(cc, "experiment10_" + cc + ".ini", configName, include_leo=True),
...
if __name__ == "__main__":
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        ...
        if(len(missingConfigs) > 0):
            ...
            raise RuntimeError("The following experiment 10 configs are still missing vec files after retries:\n" + missingText)
