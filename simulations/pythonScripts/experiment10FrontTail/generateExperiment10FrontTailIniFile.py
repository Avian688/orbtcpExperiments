...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        fileName = f'../../paperExperiments/experiment10FrontTail/experiment10FrontTail_{alg}.ini'
    ...
    out_dir = Path('../../paperExperiments/experiment10FrontTail')
    clone_raynet_ini_variants(out_dir / 'experiment10FrontTail_bbr.ini', include_leo=True)
