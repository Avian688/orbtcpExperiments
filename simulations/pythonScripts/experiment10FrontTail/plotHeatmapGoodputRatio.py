...
from plotDataExportFrontTail import export_heatmap, export_plot_dataframe
from plotProtocolSupportFrontTail import HEATMAP_PROTOCOL_TICK_STYLE, LEO_PROTOCOLS, PROTOCOL_LABELS
from raynetExperimentSupportFrontTail import protocol_config_prefix
...
def fairness_ratio(proto, pair):
    base = os.path.join("../../../paperExperiments/experiment10FrontTail/csvs",
...
export_plot_dataframe(
    ...
    metadata={
        ...
        "description": "Average-goodput table values emitted by the experiment10FrontTail aggregate table script.",
    },
)
