...
def collect_config_entries(paperExperimentDir, congControlList, runList):
    ...
    for cc in congControlList:
        fileName = paperExperimentDir / ("experiment10FrontTail_" + cc + ".ini")
...
def run_config_batch(configEntries, simulationCores, paperExperimentDir):
    configs = [
        SimulationConfig(cc, "experiment10FrontTail_" + cc + ".ini", configName, include_leo=True)
...
if __name__ == "__main__":
    ...
    experiment = "experiment10FrontTail"
    runs = 5
    runList = list(range(1,runs+1))
    scriptDir = Path(__file__).resolve().parent
    paperExperimentDir = (scriptDir / "../../paperExperiments/experiment10FrontTail").resolve()
    plotsExperimentDir = (scriptDir / "../../plots/experiment10FrontTail").resolve()

    listPairs = ["Pair1", "Pair2", "Pair3"]
    
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        subprocess.Popen("python3 generateExperiment10FrontTailIniFile.py", shell=True).communicate(timeout=30)
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 2
        ...
        folderLoc =  '../../paperExperiments/experiment10FrontTail/results/'
        ...
        for file in os.listdir(folderLoc):
            if(file.endswith(".vec")):
                ...
                processList.append(subprocess.Popen("opp_scavetool export -o "+ "results/"+ file[:-7] + ".csv -F CSV-R " + "results/" + file , shell=True, cwd='../../paperExperiments/experiment10FrontTail/'))
                ...
                if(currentProc == cores):
                     ...
                     currentProc = 0
                    #  for fil in fileList:
                    #     subprocess.Popen("rm results/" + fil , shell=True, cwd='../../paperExperiments/experiment10FrontTail/').communicate(timeout=10) #Remove VEC
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".vci" , shell=True, cwd='../../paperExperiments/experiment10FrontTail/').communicate(timeout=10) #Remove VCI
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".sca" , shell=True, cwd='../../paperExperiments/experiment10FrontTail/').communicate(timeout=10) #Remove VCI
                     fileList.clear()
                     processList.clear()
        ...
        for protocol in congControlList:
            for pair in listPairs:
                for run in runList:
                    ...
                    filePath = '../../paperExperiments/experiment10FrontTail/results/'+ protocolTitle + '_' + pair + '_Run' + str(run) + '.csv'
    ...
    #     processListStr = []
    #     filePath = '../../paperExperiments/experiment10FrontTail/results/ping_isl.csv'
    #     if os.path.exists(filePath):
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 5
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment10FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment10FrontTail/plotHeatmapGoodputRatio.py", shell=True, cwd='../../plots/experiment10FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 6
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment10FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment10FrontTail/plotGoodputEvolution.py", shell=True, cwd='../../plots/experiment10FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 7
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment10FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment10FrontTail/plotHeatmapDelay.py", shell=True, cwd='../../plots/experiment10FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    #                         dirPath = '../../plots/experiment10FrontTail/' + protocol + '/' + buf + '/' + str(rtt) + 'ms/DI' + str(di) +'ms/run' + str(run) + '/'
    ...
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotCwnd.py " + cwndFile[0], dirPath + cwndFile[1]))
                            
    #                         for rttFile in rttFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotRtt.py " + rttFile[0], dirPath + rttFile[1]))
                                    
    #                         for UFile in UFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotU.py " + UFile[0], dirPath + UFile[1]))
                                    
    #                         for goodputFile in goodputFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotGoodput.py " + goodputFile[0], dirPath + goodputFile[1]))
                                    
    #                         for queueLengthFile in queueLengthFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotQueueLength.py " + queueLengthFile[0], dirPath + queueLengthFile[1]))
                                    
    #                         for aggrePlotFile in aggrPlotsFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotCwnd.py " + aggrePlotFile[0], dirPath + aggrePlotFile[1]))
                                
    #                         for aggreGpPlotFile in aggrPlotsGoodputFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment10FrontTail/plotGoodput.py " + aggreGpPlotFile[0], dirPath + aggreGpPlotFile[1]))
    ...
    #     merge_pdfs_in_folders("../../plots/experiment10FrontTail")
