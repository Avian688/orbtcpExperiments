...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        ...
        with open(fileName, 'w') as f:
            ...
            f.write('\n' + '**.**.tcp.conn-*.u:vector.vector-recording = false')
            f.write('\n' + '**.**.tcp.conn-*.U:vector.vector-recording = true')
            f.write('\n' + '**.**.tcp.conn-*.additiveIncrease:vector.vector-recording = false')
            f.write('\n' + 'c**.**.tcp.conn-*.sharingFlows:vector.vector-recording = false')
            ...
            f.write('\n' + '**.**.tcp.conn-*.srtt:vector.vector-recording = false')
            f.write('\n' + '**.**.tcp.conn-*.queueingDelay:vector.vector-recording = false')
            f.write('\n' + '**.**.tcp.conn-*.estimatedRtt:vector.vector-recording = false')
            f.write('\n' + '**.**.tcp.conn-*.avgRtt:vector.vector-recording = false')
            f.write('\n' + '**.**.tcp.conn-*.ssthresh:vector.vector-recording = false')
            f.write('\n' + '**.**.queue.queueLength:vector.vector-recording = true')
            f.write('\n' + '**.**.queue.queueingTime:vector.vector-recording = false')
            f.write('\n' + '**.**.queue.avgRttQueue:vector.vector-recording = false')
            f.write('\n' + '**.**.ReceiverSideThroughput:vector.vector-recording = true')
            f.write('\n' + '**.**.numberOfFlows:vector.vector-recording = false')
            f.write('\n' + '**.**.alpha:vector.vector-recording = false')
            f.write('\n' + '**.**.bandwidth:vector.vector-recording = true')
            f.write('\n' + '**.**.mbytesInFlight:vector.vector-recording = true')
            f.write('\n' + '**.**.persistentQueueingDelay:vector.vector-recording = false')
