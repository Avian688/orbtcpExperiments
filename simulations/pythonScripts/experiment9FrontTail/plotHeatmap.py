...
from plotProtocolSupportFrontTail import LEO_PROTOCOLS, PROTOCOL_LABELS
...
def compute_mean_std(path_key, proto, m):
    ...
    for run in RUNS:
        ...
        PATH = f"../../../paperExperiments/experiment8FrontTail/csvs/{protocol_config_prefix(proto)}/{path_key_before}/{path_key_after}/{QMULTDICT.get(m)}/run{run}/leoconstellation.groundStation[{gs_index}].app[0]/goodput.csv"
