...
def collect_config_entries(paperExperimentDir, congControlList, runList):
    ...
    for cc in congControlList:
        fileName = paperExperimentDir / ("experiment9FrontTail_" + cc + ".ini")
...
def run_config_batch(configEntries, simulationCores, paperExperimentDir):
    configs = [
        SimulationConfig(cc, "experiment9FrontTail_" + cc + ".ini", configName, include_leo=True)
        for cc, configName in configEntries
    ]
    print(f"Running Experiment 9 simulations with up to {simulationCores} workers.")
...
if __name__ == "__main__":
    ...
    experiment = "experiment9FrontTail"
    buffersizes = ["mediumbuffer"]
    runs = 5
    runList = list(range(1,runs+1))
    scriptDir = Path(__file__).resolve().parent
    paperExperimentDir = (scriptDir / "../../paperExperiments/experiment9FrontTail").resolve()
    plotsExperimentDir = (scriptDir / "../../plots/experiment9FrontTail").resolve()
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        subprocess.Popen("python3 generateExperiment9FrontTailIniFile.py", shell=True).communicate(timeout=30)
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 2
        ...
        folderLoc =  '../../paperExperiments/experiment9FrontTail/results/'
        ...
        for file in os.listdir(folderLoc):
            if(file.endswith(".vec")):
                ...
                processList.append(subprocess.Popen("opp_scavetool export -o "+ "results/"+ file[:-7] + ".csv -F CSV-R " + "results/" + file , shell=True, cwd='../../paperExperiments/experiment9FrontTail/'))
                ...
                if(currentProc == cores):
                     ...
                     currentProc = 0
                    #  for fil in fileList:
                    #     subprocess.Popen("rm results/" + fil , shell=True, cwd='../../paperExperiments/experiment9FrontTail/').communicate(timeout=10) #Remove VEC
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".vci" , shell=True, cwd='../../paperExperiments/experiment9FrontTail/').communicate(timeout=10) #Remove VCI
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".sca" , shell=True, cwd='../../paperExperiments/experiment9FrontTail/').communicate(timeout=10) #Remove VCI
                     fileList.clear()
                     processList.clear()
                ...
                for city1, city2, modes in city_pairs:
                    ...
                    for mode in modes:
                        for run in runList:
                            ...
                            filePath = '../../paperExperiments/experiment9FrontTail/results/'+ protocolTitle + '_' + city1NoSpace + "To" + city2NoSpace + "_" + mode + '_' + buf +'_Run' + str(run) + '.csv'
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 5
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment9FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment9FrontTail/plotHeatmapGoodputRatio.py", shell=True, cwd='../../plots/experiment9FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 6
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment9FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment9FrontTail/plotHeatmapDelay.py", shell=True, cwd='../../plots/experiment9FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 7
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment9FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment9FrontTail/plotHeatmapRetransmissionRate.py", shell=True, cwd='../../plots/experiment9FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    #                         dirPath = '../../plots/experiment9FrontTail/' + protocol + '/' + buf + '/' + str(rtt) + 'ms/DI' + str(di) +'ms/run' + str(run) + '/'
    ...
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotCwnd.py " + cwndFile[0], dirPath + cwndFile[1]))
                            
    #                         for rttFile in rttFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotRtt.py " + rttFile[0], dirPath + rttFile[1]))
                                    
    #                         for UFile in UFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotU.py " + UFile[0], dirPath + UFile[1]))
                                    
    #                         for goodputFile in goodputFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotGoodput.py " + goodputFile[0], dirPath + goodputFile[1]))
                                    
    #                         for queueLengthFile in queueLengthFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotQueueLength.py " + queueLengthFile[0], dirPath + queueLengthFile[1]))
                                    
    #                         for aggrePlotFile in aggrPlotsFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotCwnd.py " + aggrePlotFile[0], dirPath + aggrePlotFile[1]))
                                
    #                         for aggreGpPlotFile in aggrPlotsGoodputFileList:
    #                             processListStr.append(("python3 ../../../../../../../pythonScripts/experiment9FrontTail/plotGoodput.py " + aggreGpPlotFile[0], dirPath + aggreGpPlotFile[1]))
    ...
    #     merge_pdfs_in_folders("../../plots/experiment9FrontTail")
