...
if __name__ == "__main__":
    ...
    numOfRuns = 5
    numOfClients = 2
    groundStationsCsv = '../experiment8/ground_stations.csv'
    ...
    for alg in algorithms:
        fileName =  '../../paperExperiments/experiment9/experiment9_' + alg +'.ini'
    ...
    out_dir = Path('../../paperExperiments/experiment9')
    clone_raynet_ini_variants(out_dir / 'experiment9_bbr.ini', include_leo=True)
