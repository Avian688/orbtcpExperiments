...
if __name__ == "__main__":
        ...
        for qs in queueSizes:
            ...
            with open(fileName, 'w') as f:
                ...
                if(algFlavour == "TcpCubic"):
                    ...
                    f.write('\n' + '**.router[0].ppp[2].queue.typename = "IntQueue"\n')
                    for i in range(1, numOfRibClients):
                        f.write('\n' + '**.router[' + str(i) + '].ppp[3].queue.typename = "IntQueue"\n')
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment6/.')]
    ...
    for qs in queueSizes:
        ...
        clone_raynet_ini_variants(out_dir / f"experiment6_bbr_{queueIniTitle}.ini")
