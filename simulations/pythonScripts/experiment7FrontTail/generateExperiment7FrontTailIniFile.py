...
def main() -> None:
    ...
    out_dir = Path("../../paperExperiments/experiment7FrontTail")
    scenarios_dir = Path("../../paperExperiments/scenarios/experiment7FrontTail")
    ...
    for alg in algorithms:
        ...
        for qs in queueSizes:
            ...
            fileName = out_dir / f"experiment7FrontTail_{alg}_{queueIniTitle}.ini"
            ...
            with fileName.open("w", encoding="utf-8") as f:
                ...
                for xmlFile in scenario_files:
                    ...
                    for i in range(numOfRuns):
                        ...
                        scenario_doc = f'xmldoc("../scenarios/experiment7FrontTail/{runName}.xml")'
    ...
    for qs in queueSizes:
        if qs == 0.2:
            ...
            queueIniTitle = f"buffer{qs}"
        clone_raynet_ini_variants(out_dir / f"experiment7FrontTail_bbr_{queueIniTitle}.ini")
