            ...
            for delay in delays:
                ...
                for protocol in protocols:
                    ...
                    for run in runs:
                        ...
                        dfs = []
                        for mod in modules:
                            modPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + mod + '.tcp.conn/throughput.csv'
                        ...
                        for dum1Mod in dumb1Modules:
                            dum1ModPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + dum1Mod + '.tcp.conn/throughput.csv'
                        ...
                        for dum2Mod in dumb2Modules:
                            dum2ModPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + mod + '.tcp.conn/throughput.csv'
