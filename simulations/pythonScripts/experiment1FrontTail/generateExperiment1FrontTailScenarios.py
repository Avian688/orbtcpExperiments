...
def main() -> None:
    ...
    folderScenario = Path("../../paperExperiments/scenarios/experiment1FrontTail/")
    folderBaseRtts = Path("../../paperExperiments/baseRtts/experiment1FrontTail/")
    folderBws = Path("../../paperExperiments/bandwidths/experiment1FrontTail/")
