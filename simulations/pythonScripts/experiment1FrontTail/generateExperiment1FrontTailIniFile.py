...
# Uses scenario XMLs in ../../paperExperiments/scenarios/experiment1FrontTail/
...
from raynetExperimentSupportFrontTail import clone_raynet_ini_variants, common_load_libs, common_ned_path, ide_load_libs_enabled
...
def main() -> None:
    ...
    out_dir = Path("../../paperExperiments/experiment1FrontTail")
    scenarios_dir = Path("../../paperExperiments/scenarios/experiment1FrontTail")
    ...
    for alg in algorithms:
        ...
        fileName = out_dir / f"experiment1FrontTail_{alg}.ini"
        ...
        with fileName.open("w", encoding="utf-8") as f:
            ...
            if alg in ("cubic", "satcp"):
                ...
                w('**.router1.ppp[1].queue.typename = "IntFrontTailQueue"')
            ...
            for xmlFile in scenario_files:
                ...
                scenario_doc = f'xmldoc("../scenarios/experiment1FrontTail/run{runNum}.xml")'
                w(f"*.scenarioManager.script = {scenario_doc}")
                if alg == "satcp":
                    w(f"**.tcp.scenario = {scenario_doc}")
                w()

    clone_raynet_ini_variants(out_dir / "experiment1FrontTail_bbr.ini")
