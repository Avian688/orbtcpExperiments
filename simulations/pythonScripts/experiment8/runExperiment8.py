...
if __name__ == "__main__":
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        ...
        with open('experiment8runTimes.txt', 'w') as f1:
            exp1RunNum = 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 2
        ...
        folderLoc =  '../../paperExperiments/experiment8/results/'
        ...
        for file in os.listdir(folderLoc):
            if(file.endswith(".vec")):
                ...
                processList.append(subprocess.Popen("opp_scavetool export -o "+ "results/"+ file[:-7] + ".csv -F CSV-R " + "results/" + file , shell=True, cwd='../../paperExperiments/experiment8/'))
                currentProc = currentProc + 1
                ...
                if(currentProc == cores):
                     ...
                     currentProc = 0
                    #  for fil in fileList:
                    #     subprocess.Popen("rm results/" + fil , shell=True, cwd='../../paperExperiments/experiment8/').communicate(timeout=10) #Remove VEC
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".vci" , shell=True, cwd='../../paperExperiments/experiment8/').communicate(timeout=10) #Remove VCI
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".sca" , shell=True, cwd='../../paperExperiments/experiment8/').communicate(timeout=10) #Remove VCI
                     fileList.clear()
                     processList.clear()
            ...
            for buf in buffersizes:
                for rtt in rtts:
                    for di in disruptionIntervals:
                        for run in runList:
                            filePath = '../../paperExperiments/experiment8/results/'+ protocol.title() + "_" + buf + "_RTT" + str(rtt) + 'ms_Disruption' + str(di) + 'ms_Run' + str(run) + '.csv'
                            print(filePath)
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 4
        subprocess.Popen("mkdir ../../plots/experiment8", shell=True).communicate(timeout=10) 
        subprocess.Popen("rm -r *", shell=True, cwd='../../plots/experiment8').communicate(timeout=200) 
    ...
    #     subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment8/').communicate(timeout=10)
    #     time.sleep(3)
    #     p = subprocess.Popen("python3 ../../../pythonScripts/experiment8/plotPrePostMethod2.py", shell=True, cwd='../../plots/experiment8/cumulative')
    #     p.wait(timeout=3600)
    #     time.sleep(1)
    # currStep += 1
    #
    ...
    #     subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment8/').communicate(timeout=10)
    #     time.sleep(3)
    #     p = subprocess.Popen("python3 ../../../pythonScripts/experiment8/plotScatter.py", shell=True, cwd='../../plots/experiment8/cumulative')
    #     p.wait(timeout=3600)
    #     time.sleep(1)
    # currStep += 1
                ...
                for rtt in rtts:
                    for di in disruptionIntervals:
                        for run in runList:
                            ...
                            dirPath = '../../plots/experiment8/' + protocol + '/' + buf + '/' + str(rtt) + 'ms/DI' + str(di) +'ms/run' + str(run) + '/'
                            ...
                            for cwndFile in cwndFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotCwnd.py " + cwndFile[0], dirPath + cwndFile[1]))
                            
                            for rttFile in rttFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotRtt.py " + rttFile[0], dirPath + rttFile[1]))
                                    
                            for UFile in UFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotU.py " + UFile[0], dirPath + UFile[1]))
                                    
                            for goodputFile in goodputFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotGoodput.py " + goodputFile[0], dirPath + goodputFile[1]))
                                    
                            for queueLengthFile in queueLengthFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotQueueLength.py " + queueLengthFile[0], dirPath + queueLengthFile[1]))
                                    
                            for aggrePlotFile in aggrPlotsFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotCwnd.py " + aggrePlotFile[0], dirPath + aggrePlotFile[1]))
                                
                            for aggreGpPlotFile in aggrPlotsGoodputFileList:
                                processListStr.append(("python3 ../../../../../../../pythonScripts/experiment8/plotGoodput.py " + aggreGpPlotFile[0], dirPath + aggreGpPlotFile[1]))
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 8
        ...
        merge_pdfs_in_folders("../../plots/experiment8")
