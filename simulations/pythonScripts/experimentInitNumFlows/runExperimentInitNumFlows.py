...
if __name__ == "__main__":
    ...
    congControlList = select_experiment_protocols(
        ["orbtcp_pint_no_initial_phase", "orbtcp_pint"]
    )
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        subprocess.Popen("python3 generateExperimentInitNumFlowsScenarios.py", shell=True).communicate(timeout=30)
        subprocess.Popen("python3 generateExperimentInitNumFlowsIniFile.py", shell=True).communicate(timeout=30)
        ...
        with open('experimentInitNumFlowsrunTimes.txt', 'w') as f1:
            ...
            for cc in congControlList:
                for bs in buffersizes:
                    ...
                    print("----------experiment InitNumFlows " + cc + " " + bs + " simulations------------")
                    for line in iniFile:
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 2
        currentProc = 0
        print("\nAll experiments in Experiment InitNumFlows has been run!\n")
        folderLoc =  '../../paperExperiments/experimentInitNumFlows/results/'
        print("------------ Generating CSV Files for experiment InitNumFlows ------------")
        
        fileList = []
        for file in os.listdir(folderLoc):
            if(file.endswith(".vec")):
                f = os.path.join(folderLoc, file)
                processList.append(subprocess.Popen("opp_scavetool export -o "+ "results/"+ file[:-7] + ".csv -F CSV-R " + "results/" + file , shell=True, cwd='../../paperExperiments/experimentInitNumFlows/'))
        ...
        processList.clear()
        currentProc = 0
    print("CSVs created for experiments InitNumFlows!\n")
    currStep += 1
                ...
                for rtt in clientsRtts:
                    for run in runList:
                        ...
                        for cwndFile in cwndFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotCwnd.py " + cwndFile[0], dirPath + cwndFile[1]))
                        
                        for rttFile in rttFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotRtt.py " + rttFile[0], dirPath + rttFile[1]))
                                
                        # for tauFile in tauFileList:
                        #     processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows//plotTau.py " + tauFile[0], dirPath + tauFile[1]))
                                
                        # for UFile in UFileList:
                        #     processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotU.py " + UFile[0], dirPath + UFile[1]))
                                
                        for goodputFile in goodputFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotGoodput.py " + goodputFile[0], dirPath + goodputFile[1]))
                                
                        for queueLengthFile in queueLengthFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotQueueLength.py " + queueLengthFile[0], dirPath + queueLengthFile[1]))
                                
                        for aggrePlotFile in aggrPlotsFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotCwnd.py " + aggrePlotFile[0], dirPath + aggrePlotFile[1]))
                            
                        for aggreGpPlotFile in aggrPlotsGoodputFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experimentInitNumFlows/plotGoodput.py " + aggreGpPlotFile[0], dirPath + aggreGpPlotFile[1]))
