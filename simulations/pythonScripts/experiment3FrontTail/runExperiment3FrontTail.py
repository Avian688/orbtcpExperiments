...
if __name__ == "__main__":
    ...
    currentProc = 0
    processList = []
    congControlList = select_experiment_protocols(["bbr3", "bbr", "orbtcp", "cubic"])
    experiment = "experiment3FrontTail"
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 1
        ...
        subprocess.Popen("python3 generateExperiment3FrontTailScenario.py", shell=True).communicate(timeout=30)
        subprocess.Popen("python3 generateExperiment3FrontTailIniFile.py", shell=True).communicate(timeout=30)
    
        Path("experiment3FrontTailrunTimes.txt").unlink(missing_ok=True)
        
        with open('experiment3FrontTailrunTimes.txt', 'w') as f1:
            ...
            for cc in congControlList:
                for bs in buffersizes:
                    ...
                    iniName = "experiment3FrontTail_" + cc + "_" + bs + ".ini"
                    simulation_configs.extend(collect_simulation_configs(
                        cc, iniName, runList, "../../paperExperiments/experiment3FrontTail"
                    ))
            run_simulation_configs(simulation_configs, "../../paperExperiments/experiment3FrontTail", cores, f1)
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 2
        ...
        folderLoc =  '../../paperExperiments/experiment3FrontTail/results/'
        ...
        for file in os.listdir(folderLoc):
            if(file.endswith(".vec")):
                ...
                processList.append(subprocess.Popen("opp_scavetool export -o "+ "results/"+ file[:-7] + ".csv -F CSV-R " + "results/" + file , shell=True, cwd='../../paperExperiments/experiment3FrontTail/'))
                ...
                if(currentProc == cores):
                     ...
                     currentProc = 0
                    #  for fil in fileList:
                    #     subprocess.Popen("rm results/" + fil , shell=True, cwd='../../paperExperiments/experiment3FrontTail/').communicate(timeout=10) #Remove VEC
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".vci" , shell=True, cwd='../../paperExperiments/experiment3FrontTail/').communicate(timeout=10) #Remove VCI
                    #     subprocess.Popen("rm results/" + fil[:-4] + ".sca" , shell=True, cwd='../../paperExperiments/experiment3FrontTail/').communicate(timeout=10) #Remove VCI
                     fileList.clear()
                     processList.clear()
        ...
        for protocol in congControlList:
            for buf in buffersizes:
                for rtt in movingClientsRtts:
                    for run in runList:
                        filePath = '../../paperExperiments/experiment3FrontTail/results/'+ protocol_config_prefix(protocol) + str(rtt) + 'ms' + buf + 'Run' + str(run) + '.csv'
                        print(filePath)
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 4
        subprocess.Popen("mkdir ../../plots/experiment3FrontTail", shell=True).communicate(timeout=10) 
        subprocess.Popen("rm -r *", shell=True, cwd='../../plots/experiment3FrontTail').communicate(timeout=200) 
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 5
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment3FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment3FrontTail/plotPrePostMethod2.py", shell=True, cwd='../../plots/experiment3FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 6
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment3FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/runPlotVariantsFrontTail.py ../../../pythonScripts/experiment3FrontTail/plotScatterFixed.py", shell=True, cwd='../../plots/experiment3FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 7
        ...
        subprocess.Popen("mkdir cumulative", shell=True, cwd='../../plots/experiment3FrontTail/').communicate(timeout=10)
        time.sleep(3)
        p = subprocess.Popen("python3 ../../../pythonScripts/experiment3FrontTail/printAverageRTTs.py", shell=True, cwd='../../plots/experiment3FrontTail/cumulative')
        p.wait(timeout=3600)
        time.sleep(1)
    currStep += 1
            ...
            for buf in buffersizes:
                for rtt in movingClientsRtts:
                    for run in runList:
                        ...
                        dirPath = '../../plots/experiment3FrontTail/' + protocol + '/' + buf + '/' + str(rtt) + 'ms' + '/run' + str(run) + '/'
                        ...
                        for cwndFile in cwndFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotCwnd.py " + cwndFile[0], dirPath + cwndFile[1]))
                        
                        for rttFile in rttFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotRtt.py " + rttFile[0], dirPath + rttFile[1]))
                                
                        for UFile in UFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotU.py " + UFile[0], dirPath + UFile[1]))
                                
                        for goodputFile in goodputFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotGoodput.py " + goodputFile[0], dirPath + goodputFile[1]))
                                
                        for queueLengthFile in queueLengthFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotQueueLength.py " + queueLengthFile[0], dirPath + queueLengthFile[1]))
                                
                        for aggrePlotFile in aggrPlotsFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotCwnd.py " + aggrePlotFile[0], dirPath + aggrePlotFile[1]))
                            
                        for aggreGpPlotFile in aggrPlotsGoodputFileList:
                            processListStr.append(("python3 ../../../../../../../pythonScripts/experiment3FrontTail/plotGoodput.py " + aggreGpPlotFile[0], dirPath + aggreGpPlotFile[1]))
    ...
    if(currStep <= endStep and currStep >= startStep): #STEP 8
        ...
        merge_pdfs_in_folders("../../plots/experiment3FrontTail")
