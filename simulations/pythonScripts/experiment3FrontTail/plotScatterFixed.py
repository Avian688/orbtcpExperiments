...
from plotProtocolSupportFrontTail import CORE_PROTOCOLS, PROTOCOL_COLORS, PROTOCOL_LABELS
                    ...
                    for run in runs:
                        ...
                        for dumbbell in range(1, 3):
                            for flow_id in range(1, flows+1):
                                ...
                                csv_path = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay*2) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + modName + '[' + str(flow_id-1) + '].app[0]/goodput.csv'
