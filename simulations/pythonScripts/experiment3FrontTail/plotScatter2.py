...
from plotProtocolSupportFrontTail import CORE_PROTOCOLS, PROTOCOL_COLORS, PROTOCOL_LABELS, PROTOCOL_REJOIN_COLORS
                    ...
                    for run in runs:
                        ...
                        for dumbbell in range(1, 3):
                            for flow_id in range(1, flows+1):
                                ...
                                # Read goodput CSV
                                csv_path = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + modName + '[' + str(flow_id-1) + '].app[0]/goodput.csv'
                        ...
                        dfs = []
                        for mod in modules:
                            modPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + mod + '.app[0]/goodput.csv'
                        ...
                        for dum1Mod in dumb1Modules:
                            dum1ModPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + dum1Mod + '.app[0]/goodput.csv'
                        ...
                        for dum2Mod in dumb2Modules:
                            dum2ModPath = root_path + "/paperExperiments/experiment3FrontTail/csvs/" + protocol + "/" + QMULTDICT.get(mult) + '/' + str(delay) + 'ms/run' + str(run) + '/doubledumbbellpathchange.' + mod + '.app[0]/goodput.csv'
