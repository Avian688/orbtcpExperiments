...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        for qs in queueSizes:
            ...
            fileName =  '../../paperExperiments/experiment3FrontTail/experiment3FrontTail' + '_' + alg + '_' + queueIniTitle + '.ini'
            ...
            with open(fileName, 'w') as f:
                ...
                if(algFlavour == "TcpCubic"):
                    ...
                    f.write('\n' + '**.constantRouter1.ppp[2].queue.typename = "IntFrontTailQueue"\n')
                    f.write('\n' + '**.pathChangeRouter1.ppp[2].queue.typename = "IntFrontTailQueue"\n')
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment3FrontTail/.')]
                ...
                for xmlFile in dir:
                    ...
                    for i in range(numOfRuns):
                        ...
                        f.write('\n' + '*.scenarioManager.script = xmldoc("../scenarios/experiment3FrontTail/'+ str(scenarioName) + '.xml")\n')
    out_dir = Path('../../paperExperiments/experiment3FrontTail')
    for qs in queueSizes:
        if(qs == 0.2):
            queueIniTitle = "smallbuffer"
        elif(qs == 1):
        ...
        clone_raynet_ini_variants(out_dir / f"experiment3FrontTail_bbr_{queueIniTitle}.ini")
