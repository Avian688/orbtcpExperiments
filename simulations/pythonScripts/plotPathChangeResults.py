    ...
    for arg in sys.argv[1:]:
        ...
        for file in os.listdir(folderLoc):
            if(file.endswith(".csv")):
                ...
                processList.append("python3 ../../../../pythonScripts/plotPathChangeQueueLength.py ../../../" + folderLoc + file)
                processList.append("python3 ../../../../pythonScripts/plotPathChangeQueueingTime.py ../../../" + folderLoc + file)
