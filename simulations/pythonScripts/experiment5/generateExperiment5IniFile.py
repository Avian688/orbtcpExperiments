...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        for qs in queueSizes:
            ...
            fileName =  '../../paperExperiments/experiment5/experiment5' + '_' + alg + '_' + queueIniTitle + '.ini'
            ...
            with open(fileName, 'w') as f:
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment5/.')]
                ...
                for xmlFile in dir:
                    ...
                    for i in range(numOfRuns):
                        ...
                        f.write('\n' + '*.scenarioManager.script = xmldoc("../scenarios/experiment5/'+ str(scenarioName) + '.xml")\n')
                        f.write('\n' + 'sim-time-limit = ' + str(rtt * 2000) +'s \n')
    out_dir = Path('../../paperExperiments/experiment5')
    for qs in queueSizes:
        if(qs == 0.2):
            queueIniTitle = "smallbuffer"
        elif(qs == 1):
