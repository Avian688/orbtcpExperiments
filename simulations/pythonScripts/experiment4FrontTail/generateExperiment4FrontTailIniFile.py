...
if __name__ == "__main__":
    ...
    for alg in algorithms:
        for qs in queueSizes:
            ...
            fileName =  '../../paperExperiments/experiment4FrontTail/experiment4FrontTail' + '_' + alg + '_' + queueIniTitle + '.ini'
            ...
            with open(fileName, 'w') as f:
                ...
                dir = [f for f in os.listdir('../../paperExperiments/scenarios/experiment4FrontTail/.')]
                ...
                for xmlFile in dir:
                    ...
                    for i in range(numOfRuns):
                        ...
                        scenario_doc = 'xmldoc("../scenarios/experiment4FrontTail/'+ str(scenarioName) + '.xml")'
                        f.write('\n' + '*.scenarioManager.script = ' + scenario_doc + '\n')
                        if alg == "satcp":
                            f.write('\n' + '**.tcp.scenario = ' + scenario_doc + '\n')
                        f.write('\n' + 'sim-time-limit = ' + str(rtt * 2000) +'s \n')
    out_dir = Path('../../paperExperiments/experiment4FrontTail')
    for qs in queueSizes:
        if(qs == 0.2):
            queueIniTitle = "smallbuffer"
        elif(qs == 1):
        ...
        clone_raynet_ini_variants(out_dir / f"experiment4FrontTail_bbr_{queueIniTitle}.ini")
