...
def main() -> None:
    ...
    folderScenario = Path("../../paperExperiments/scenarios/experiment2/")
    folderBaseRtts = Path("../../paperExperiments/baseRtts/experiment2/")
    folderBws = Path("../../paperExperiments/bandwidths/experiment2/")
